...
export -f luxx \n
')
    if ! cat ~/.bashrc | grep -e "function luxx" &>/dev/null; then
...
function func_setenv()
{
  ...
  func_toolchain
    ...
    echo -e ${ylw}"Checking env : \e[1;38;5;81m$mypyt\033[0m | \e[1;38;5;81m$myjdk\033[0m | \e[1;38;5;81m$myrom\033[0m | \e[1;38;5;81m${system_kati}\033[0m | \e[1;38;5;81m${inject_luxx}\033[0m | \e[1;38;5;81m${sdclang_version}"${txtrst};
