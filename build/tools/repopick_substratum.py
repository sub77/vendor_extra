...
if args.topic:
    url = 'http://substratum.review/changes/?q=topic:%s' % args.topic
    if args.verbose:
...
for change in args.change_number:
    ...
    #   )]}'
    #   [ ... valid JSON ... ]
    url = 'https://substratum.review/changes/?q=%s&o=CURRENT_REVISION&o=CURRENT_COMMIT&pp=0' % change
    if args.verbose:
    ...
    for (i, data) in enumerate(data_array):
        ...
        #project_name = int(os.environ['PROJECT_NAME'])
