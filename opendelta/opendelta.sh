...
BIN_JAVA=java
BIN_MINSIGNAPK=$HOME/omni8/vendor/extra/opendelta/delta/minsignapk.jar
BIN_XDELTA=$HOME/omni8/vendor/extra/opendelta/delta/xdelta3
BIN_ZIPADJUST=$HOME/omni8/vendor/extra/opendelta/delta/zipadjust

FILE_MATCH=omni-*.zip
PATH_CURRENT=$HOME/omni8/out/target/product/$DEVICE
PATH_LAST=$HOME/omni8/vendor/extra/opendelta/last/$DEVICE

KEY_X509=$HOME/omni8/vendor/extra/opendelta/.keys/platform.x509.pem
KEY_PK8=$HOME/omni8/vendor/extra/opendelta/.keys/platform.pk8
