...
mkdir publish/delta >/dev/null 2>/dev/null
mkdir publish/full >/dev/null 2>/dev/null
mkdir publish/delta/$DEVICE >/dev/null 2>/dev/null
mkdir publish/full/$DEVICE >/dev/null 2>/dev/null
cp out/* publish/delta/$DEVICE/.
cp $PATH_CURRENT/$FILE_CURRENT publish/full/$DEVICE/
cp $PATH_CURRENT/$FILE_CURRENT.md5sum publish/full/$DEVICE/
